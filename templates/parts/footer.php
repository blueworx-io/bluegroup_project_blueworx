...
<div class="cta-soft">
	<div class="cta-inner">
		...
		?>
		<h2 class="h2"><?php echo esc_html__( 'Ready to Build a Digital Solution That Wins?', 'blueworx-site' ); ?></h2>
		<p><?php echo esc_html__( "Book a free strategy call. We'll review your current setup and show you exactly where the opportunities are.", 'blueworx-site' ); ?></p>
		<div class="cta-actions">
			<a href="<?php echo esc_url( home_url( '/pricing' ) ); ?>" class="btn btn-brand btn-md"><?php echo esc_html__( 'Get a Quote', 'blueworx-site' ); ?></a>
			<a href="<?php echo esc_url( home_url( '/contact' ) ); ?>" class="btn btn-outline-w btn-md"><?php echo esc_html__( 'Book a Call', 'blueworx-site' ); ?></a>
		</div>
	</div>
</div>
<footer>
	<div class="ft">
		<div class="fb">
			<?php if ( file_exists( $blueworx_footer_logo_path ) ) : ?>
				<img
					...
					alt="<?php echo esc_attr__( 'BlueWorx', 'blueworx-site' ); ?>"
					style="filter:brightness(0) invert(1)"
				/>
			<?php else : ?>
				<span class="bw-footer-logo-text"><?php echo esc_html( get_bloginfo( 'name' ) ); ?></span>
			<?php endif; ?>
			<p><?php echo esc_html__( 'BlueWorx supports growing businesses worldwide with premium tools, hosting, and expert support.', 'blueworx-site' ); ?></p>
			<div class="fsocial">
				<a aria-label="<?php echo esc_attr__( 'Facebook', 'blueworx-site' ); ?>">
				...
				<a aria-label="<?php echo esc_attr__( 'LinkedIn', 'blueworx-site' ); ?>">
				...
				<a aria-label="<?php echo esc_attr__( 'Twitter', 'blueworx-site' ); ?>">
		...
		<div class="fcol">
			<h4><?php echo esc_html__( 'Pages', 'blueworx-site' ); ?></h4>
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo esc_html__( 'Home', 'blueworx-site' ); ?></a>
			<a href="<?php echo esc_url( home_url( '/services' ) ); ?>"><?php echo esc_html__( 'Services', 'blueworx-site' ); ?></a>
			<a href="<?php echo esc_url( home_url( '/ai' ) ); ?>"><?php echo esc_html__( 'AI Powered', 'blueworx-site' ); ?></a>
			<a href="<?php echo esc_url( home_url( '/work' ) ); ?>"><?php echo esc_html__( 'Work', 'blueworx-site' ); ?></a>
			<a href="<?php echo esc_url( home_url( '/toolbox' ) ); ?>"><?php echo esc_html__( 'Toolbox', 'blueworx-site' ); ?></a>
			<a href="<?php echo esc_url( home_url( '/about' ) ); ?>"><?php echo esc_html__( 'About Us', 'blueworx-site' ); ?></a>
			<a href="<?php echo esc_url( home_url( '/pricing' ) ); ?>"><?php echo esc_html__( 'Pricing', 'blueworx-site' ); ?></a>
		</div>
		<div class="fcol">
			<h4><?php echo esc_html__( 'About', 'blueworx-site' ); ?></h4>
			<a><?php echo esc_html__( 'Blog', 'blueworx-site' ); ?></a>
			<a href="<?php echo esc_url( home_url( '/contact' ) ); ?>"><?php echo esc_html__( 'Contact', 'blueworx-site' ); ?></a>
			<a><?php echo esc_html__( 'Resources', 'blueworx-site' ); ?></a>
			<a><?php echo esc_html__( 'Careers', 'blueworx-site' ); ?></a>
		</div>
		<div class="fnews">
			<h4 style="font-size:14px;font-weight:600;color:#fff;margin-bottom:16px;"><?php echo esc_html__( 'Newsletters', 'blueworx-site' ); ?></h4>
			<p><?php echo esc_html__( 'Curious about new developments & updates? Sign up for our newsletter!', 'blueworx-site' ); ?></p>
			<div class="fnews-in">
				<input placeholder="<?php echo esc_attr__( 'email@.blueworx.com', 'blueworx-site' ); ?>" aria-label="<?php echo esc_attr__( 'Email address', 'blueworx-site' ); ?>" />
				<button aria-label="<?php echo esc_attr__( 'Subscribe', 'blueworx-site' ); ?>">
		...
		<p>
			...
			echo esc_html(
				sprintf(
					...
					__( '© %s BlueWorx. All rights reserved.', 'blueworx-site' ),
					gmdate( 'Y' )
				)
			);
			?>
		</p>
		<p><?php echo esc_html__( 'Powered by BabyBlue Digital.', 'blueworx-site' ); ?></p>
	</div>
</footer>
