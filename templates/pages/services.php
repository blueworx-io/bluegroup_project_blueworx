...
$blueworx_svc_feat_highlights = array(
	array(
		...
		'desc'  => __( 'Branding, UX/UI, and custom graphics. Every touchpoint designed to convert.', 'bluegroup-project-blueworx' ),
	),
	array(
		'icon'  => 'code',
		'title' => __( 'Development', 'bluegroup-project-blueworx' ),
		'desc'  => __( 'Page builds, integrations, forms, booking systems, and e-commerce.', 'bluegroup-project-blueworx' ),
	),
	array(
		'icon'  => 'chat',
		'title' => __( 'Support', 'bluegroup-project-blueworx' ),
		'desc'  => __( 'Reactive assistance and guidance from a team that already knows your site.', 'bluegroup-project-blueworx' ),
	),
	array(
		'icon'  => 'chart',
		'title' => __( 'Reporting', 'bluegroup-project-blueworx' ),
		'desc'  => __( 'Monthly traffic and key-metric reports, in plain English.', 'bluegroup-project-blueworx' ),
	),
);

$blueworx_svc_toolbox_checks = array(
	__( '12+ premium tools, set up and managed for you', 'bluegroup-project-blueworx' ),
	__( 'Managed website hosting included in the fee', 'bluegroup-project-blueworx' ),
	__( 'Learning Center guides for every tool and system', 'bluegroup-project-blueworx' ),
	__( 'Available to individuals — and in bulk for agencies', 'bluegroup-project-blueworx' ),
);
...
$blueworx_svc_glass_tools = array(
	array(
		'slug' => 'surecart',
		'name' => 'SureCart',
		'sub'  => __( 'E-commerce & checkout', 'bluegroup-project-blueworx' ),
	),
	array(
		'slug' => 'sureforms',
		'name' => 'SureForms',
		'sub'  => __( 'Forms & lead capture', 'bluegroup-project-blueworx' ),
	),
	array(
		'slug' => 'surerank',
		'name' => 'SureRank',
		'sub'  => __( 'SEO & search visibility', 'bluegroup-project-blueworx' ),
	),
	array(
		'slug' => 'ottokit',
		'name' => 'OttoKit',
		'sub'  => __( 'Workflow automation', 'bluegroup-project-blueworx' ),
	),
	array(
		'slug' => 'elementor',
		'name' => 'Elementor',
		'sub'  => __( 'Visual page building', 'bluegroup-project-blueworx' ),
	),
);
	...
	<div>
			...
			<div class="tech-inner tech-2col">
				<div class="tc-copy">
					...
					blueworx_public_part(
						...
						array(
							'centered'        => false,
							'badge'           => __( 'Our Services', 'bluegroup-project-blueworx' ),
							'title'           => __( 'Two Services. One Accountable Team.', 'bluegroup-project-blueworx' ),
							'title_highlight' => __( 'One Accountable Team.', 'bluegroup-project-blueworx' ),
							'lead'            => __( 'An integrated dev team that works inside your business, and a Digital Toolbox that replaces a stack of individual subscriptions, hosting included.', 'bluegroup-project-blueworx' ),
							'cta'             => array(
								array(
								...
								array(
									'label' => __( 'View Our Work', 'bluegroup-project-blueworx' ),
									'href'  => home_url( '/work' ),
									'class' => 'btn btn-outline-w btn-lg',
								),
							),
							'meta'            => array(
								__( 'integrated support', 'bluegroup-project-blueworx' ),
								__( 'digital toolbox', 'bluegroup-project-blueworx' ),
				...
				ob_start();
				?>
				<div class="gc-metric"><small><?php echo esc_html__( 'Web pageviews', 'bluegroup-project-blueworx' ); ?></small><b>98,745</b><span class="up">↑ 24%</span></div>
				<div class="gc-metric"><small><?php echo esc_html__( 'Conversion rate', 'bluegroup-project-blueworx' ); ?></small><b>4.9%</b><span class="up">↑ 0.8%</span></div>
				<div class="gc-metric" style="border-bottom:none;padding-bottom:4px"><small><?php echo esc_html__( 'Core Web Vitals', 'bluegroup-project-blueworx' ); ?></small><b><?php echo esc_html__( 'Pass', 'bluegroup-project-blueworx' ); ?></b><span class="up">98 / 100</span></div>
				<div class="gc-spark">
				...
				blueworx_public_part(
					...
					array(
						'tag'    => __( 'performance.live', 'bluegroup-project-blueworx' ),
		...
		<section class="sec" style="padding-top:70px;padding-bottom:76px">
			<div class="svc01-head" style="display:grid;grid-template-columns:1.05fr 0.95fr;gap:56px;align-items:end;margin-bottom:40px">
				<div>
					<div class="eyebrow" style="margin-bottom:18px"><?php echo esc_html__( 'Service 01 · Integrated Support', 'bluegroup-project-blueworx' ); ?></div>
					<h2 class="h2"><?php echo esc_html__( 'A full dev team, integrated into your business', 'bluegroup-project-blueworx' ); ?></h2>
				</div>
				<div>
					<p class="lead" style="font-size:17px"><?php echo esc_html__( 'Designers, developers, and strategists who work as an extension of your own team, without the overhead of hiring one. Request what you need; we deliver it, then keep improving it.', 'bluegroup-project-blueworx' ); ?></p>
					<div style="margin-top:18px">
						<a href="<?php echo esc_url( home_url( '/pricing' ) ); ?>" class="btn btn-dark btn-md">
							<?php echo esc_html__( 'View Support Plans', 'bluegroup-project-blueworx' ); ?>
							<?php
				...
				<div style="background:#fff;border-radius:14px;border:1px solid #ECECF3;box-shadow:0 18px 40px rgba(10,12,41,.10);overflow:hidden">
					...
					<div style="display:flex;align-items:center;gap:36px;padding:22px 28px">
						<div style="flex-shrink:0">
							<div style="font-size:12px;color:#667085;margin-bottom:4px"><?php echo esc_html__( 'Revenue this month', 'bluegroup-project-blueworx' ); ?></div>
						...
						<div style="flex-shrink:0;border-left:1px solid #F0F0F5;padding-left:36px">
							<div style="font-size:12px;color:#667085"><?php echo esc_html__( 'Web pageviews', 'bluegroup-project-blueworx' ); ?></div>
							...
							<div style="font-size:12px;color:#01824C"><?php echo esc_html__( '↑ this month', 'bluegroup-project-blueworx' ); ?></div>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="sec" style="padding-top:24px">
			<div class="center-head" style="margin-bottom:40px">
				<div class="eyebrow" style="margin-bottom:20px"><?php echo esc_html__( 'How It Works', 'bluegroup-project-blueworx' ); ?></div>
				<h2 class="h2"><?php echo esc_html__( 'From first conversation to live solution', 'bluegroup-project-blueworx' ); ?></h2>
			</div>
			<?php
			blueworx_public_part(
				'parts/proc-grid.php',
				array(
					'items' => array(
						array(
							...
							'desc'  => __( 'Come to us with a problem. We talk it through and identify exactly what your business needs.', 'bluegroup-project-blueworx' ),
						),
						array(
							'num'   => '02',
							'title' => __( 'Configure Your Package', 'bluegroup-project-blueworx' ),
							'desc'  => __( 'We configure a package around your needs and budget, then you sign up.', 'bluegroup-project-blueworx' ),
						),
						array(
							'num'   => '03',
							'title' => __( 'Scope, Design & Build', 'bluegroup-project-blueworx' ),
							'desc'  => __( 'We scope, design, and build your digital solution, powered by the Toolbox for expanded value.', 'bluegroup-project-blueworx' ),
						),
						array(
							'num'   => '04',
							'title' => __( 'Support & Grow', 'bluegroup-project-blueworx' ),
							'desc'  => __( 'Once live, we move into a support and growth role: updates, reporting, and a team on call.', 'bluegroup-project-blueworx' ),
						),
					),
				)
			);
		...
		<section class="sec" style="background:#0A0C29;position:relative;overflow:hidden">
			...
			<div class="af-wrap" style="position:relative">
				<div class="af-text">
					<div class="eyebrow" style="margin-bottom:20px;border-color:rgba(139,142,255,.28);background:rgba(139,142,255,.08);color:#B7B9FF"><?php echo esc_html__( 'Service 02 · Digital Toolbox', 'bluegroup-project-blueworx' ); ?></div>
					<h2 class="h2" style="color:#fff"><?php echo esc_html__( 'Every premium tool. One subscription.', 'bluegroup-project-blueworx' ); ?></h2>
					<p class="lead" style="margin-top:16px"><?php echo esc_html__( 'All BlueWorx clients get the full Digital Toolbox (forms, SEO, e-commerce, automation, and more) without paying for individual licences. Website hosting is included in the fee.', 'bluegroup-project-blueworx' ); ?></p>
					...
					<div style="display:flex;gap:14px;flex-wrap:wrap">
						<a href="<?php echo esc_url( home_url( '/toolbox' ) ); ?>" class="btn btn-brand btn-md">
							<?php echo esc_html__( 'View Toolbox Plans', 'bluegroup-project-blueworx' ); ?>
							<?php
							// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- static trusted markup, see $blueworx_svc_arrow above.
							echo $blueworx_svc_arrow;
							?>
						</a>
						<a href="<?php echo esc_url( home_url( '/toolbox#savings' ) ); ?>" class="btn btn-outline-w btn-md"><?php echo esc_html__( 'Calculate Your Savings', 'bluegroup-project-blueworx' ); ?></a>
					</div>
				</div>
				<?php
				ob_start();
				...
				<a href="<?php echo esc_url( home_url( '/toolbox' ) ); ?>" style="display:block;margin-top:16px;padding-top:16px;border-top:1px solid rgba(255,255,255,.09);font-size:13px;color:rgba(226,228,255,.55);text-align:center;text-decoration:none">
					<?php echo esc_html__( '+ 7 more tools, hosting & Learning Center in every plan', 'bluegroup-project-blueworx' ); ?>
				</a>
				<?php
				...
				blueworx_public_part(
					'parts/glass-card.php',
					array(
						'tag'    => __( 'toolbox · included', 'bluegroup-project-blueworx' ),
						'body'   => $blueworx_svc_toolbox_gc_body,
						'floats' => array(
							array(
								'icon'  => 'server',
								'label' => __( 'Hosting', 'bluegroup-project-blueworx' ),
								'value' => __( 'Included', 'bluegroup-project-blueworx' ),
